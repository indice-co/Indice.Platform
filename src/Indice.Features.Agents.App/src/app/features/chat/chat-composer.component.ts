...
const ICON_PATHS: Record<string, string> = {
  ...
  gear: 'M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7zm7.4 3.5a7.7 7.7 0 0 0-.1-1l2-1.6-2-3.4-2.4 1a7.9 7.9 0 0 0-1.7-1L15 3h-6l-.2 2.9a7.9 7.9 0 0 0-1.7 1l-2.4-1-2 3.4 2 1.6a7.7 7.7 0 0 0 0 2.1l-2 1.6 2 3.4 2.4-1a7.9 7.9 0 0 0 1.7 1L9 21h6l.2-2.9a7.9 7.9 0 0 0 1.7-1l2.4 1 2-3.4-2-1.6c.1-.3.1-.7.1-1.1z',
