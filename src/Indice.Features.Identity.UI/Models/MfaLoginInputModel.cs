...
public class MfaLoginInputModel
{
    ...
    /// <summary>The recovery code entered by the user when using recovery code authentication.</summary>
    ...
    /// <summary>The <c>Code</c> of the user-selected authentication method (e.g. <c>"Sms"</c>, <c>"AuthenticatorApp"</c>)</summary>
    public string? SelectedAuthenticationMethodCode { get; set; }
}
