...
/// <summary>Helper extensions that manipulate the <see cref="SpaUIOptions"/>.</summary>
public static class SpaUIOptionsExtensions
{
    /// <summary>Injects additional JavaScript files into the index.html page.</summary>
    ...
    /// <summary>Injects additional CSS style-sheets into the index.html page.</summary>
    /// <param name="options">Options for configuring <see cref="SpaUIMiddleware{TOptions}"/> middleware.</param>
