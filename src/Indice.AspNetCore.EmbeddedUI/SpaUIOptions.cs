...
namespace Indice.AspNetCore.EmbeddedUI
{
    ...
    public class SpaUIOptions
    {
        ...
        /// <summary>Specifies the title (shown in browser tab) used in the back-office application. Defaults to <b>Indice BackOffice UI</b>.</summary>
        ...
        /// <summary>Specifies whether the back-office application is served in the specified path, as dictated by the <see cref="Path"/> property. Can be used in scenarios where the back-office application needs to be hidden. Defaults to true.</summary>
        ...
        /// <summary>The path that the back-office application is served. Defaults to '/backoffice'.</summary>
        ...
        /// <summary></summary>
        public Func<HttpContext, string> TenantIdAccessor { get; set; }
