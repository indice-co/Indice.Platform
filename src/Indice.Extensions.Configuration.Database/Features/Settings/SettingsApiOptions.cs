...
public class SettingsApiOptions
{
    ...
    /// <summary>The default scope name to be used for Settings API. Defaults to <see cref="SettingsApi.Scope"/>.</summary>
    public string RequiredScope { get; set; } = SettingsApi.Scope;
    /// <summary>list of Authentication schemes. If left empty the default scheme will be used</summary>
