...
/// <summary>Contains extension methods on <see cref="IMvcBuilder"/> for configuring Settings API feature.</summary>
public static class SettingsApiFeatureExtensions
{
    /// <summary>Add the Settings API endpoints in the MVC project.</summary>
