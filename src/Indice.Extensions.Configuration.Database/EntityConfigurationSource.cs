...
/// <summary>Represents database secrets as an <see cref="IConfigurationSource"/>.</summary>
internal class EntityConfigurationSource<TContext> : IConfigurationSource where TContext : DbContext, IAppSettingsDbContext
{
    ...
    /// <summary>Creates a new instance of <see cref="EntityConfigurationSource{T}"/>.</summary>
    ...
    /// <summary>Builds the <see cref="IConfigurationProvider"/> for this source.</summary>
