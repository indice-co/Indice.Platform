...
/// <summary>Settings related to APIs.</summary>
public class ApiSettings
{
    /// <summary>Security wise the name of the API. Used for identifying the API as a resource in OAuth2 as well as the main scope.</summary>
    public string ResourceName { get; set; } = "api1";
    /// <summary>List of secrets. Usualy here is the API secret used to communicate with IdentityServer in order to exchange the reference tokens with actual info.</summary>
    public Dictionary<string, string> Secrets { get; set; } = new Dictionary<string, string>();
    /// <summary>The scopes available for the API.</summary>
    public List<Scope> Scopes { get; set; } = new List<Scope>();
    /// <summary>Friendly name for the API.</summary>
