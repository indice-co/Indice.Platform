...
namespace Microsoft.Extensions.Configuration
{
    ...
    public static class IConfigurationExtensions
    {
        ...
        /// <summary>
        /// A string that represents the default hostname binding for this web application <see cref="GeneralSettings.Host"/>.
        /// </summary>
        /// <param name="configuration">Represents a set of key/value application configuration properties.</param>
        ...
        /// <summary>
        /// A string that represents the default hostname binding for the identity provider (aka authority) for this application <see cref="GeneralSettings.Authority"/>.
        /// </summary>
        /// <param name="configuration">Represents a set of key/value application configuration properties.</param>
