...
/// <summary>Extension methods related to building dynamic queries involving the translation of query specifications (<see cref="FilterClause"/>) and sort expressions (<seealso cref="SortByClause"/>).</summary>
public static class DynamicExtensions
{
    ...
    /// <summary>x => JsonFunctions.JsonValue(x, path)</summary>
    ...
    /// <summary>x => x.Member.Path</summary>
