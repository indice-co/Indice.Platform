...
export interface IIdentityApiService {
     ...
     * @param sort (optional) 
     * @param search (optional) 
     * @param consentType (optional) The type of user consent.
     ...
     * @param signInType (optional) Describes the user sign in type in terms of user presence.
     * @return OK
     */
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.scopes)) {
            ...
            for (let item of this.scopes)
                data["scopes"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.secrets)) {
            data["secrets"] = [];
            for (let item of this.secrets)
                data["secrets"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
...
export class ClaimTypeInfo implements IClaimTypeInfo {
    ...
    reserved?: boolean;
    /** Determines whether this is a system generated claim. */
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.passwordRules)) {
            ...
            for (let item of this.passwordRules)
                data["passwordRules"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.tokens)) {
            ...
            for (let item of this.tokens)
                data["tokens"].push(item ? item.toJSON() : <any>undefined);
        }
...
export class UserClientInfo implements IUserClientInfo {
    ...
    /** The issued grants requested by the client and granted by the user. */
    grants?: UserGrantInfo[] | undefined;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.grants)) {
            ...
            for (let item of this.grants)
                data["grants"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
...
export class UserGrantInfo implements IUserGrantInfo {
    ...
    /** Grant type. */
    type?: string | undefined;
    /** Grant creation System.DateTime. */
    createdAt?: Date;
    /** Grant expiration System.DateTime. */
    expiresAt?: Date | undefined;
    /** The jti token identifier claim for the accss token. */
    tokenId?: string | undefined;
    /** The device id that created the grant. */
    deviceId?: string | undefined;
    /** The IP address of the user that created the grant. */
    ipAddress?: string | undefined;
