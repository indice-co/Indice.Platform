...
export interface IIdentityApiService {
     ...
     * @return OK
     */
    getConsents(page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined, consentType?: UserConsentType | undefined, clientId?: string | undefined): Observable<UserConsentInfoResultSet>;
    /**
