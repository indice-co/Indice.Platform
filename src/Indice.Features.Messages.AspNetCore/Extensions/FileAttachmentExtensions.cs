...
/// <summary>Extension methods on <see cref="FileAttachment"/> type.</summary>
public static class FileAttachmentExtensions
{
    /// <summary>Populates an instance of <see cref="FileAttachment"/> from an <see cref="IFormFile"/>.</summary>
