...
public static class ActivityLogFeatureExtensions
{
    ...
    /// <returns></returns>
    public static IHostApplicationBuilder AddActivityLogs(this IHostApplicationBuilder builder, Action<ActivityLogOptions> configure) {
    ...
    public static void UseEntityFrameworkCoreStore(this IHostApplicationBuilder builder, Action<IServiceProvider, DbContextOptionsBuilder> configure) {
        var services = builder.Services;
    ...
    /// <param name="configure">Provides a simple API surface for configuring <see cref="DbContextOptions" />.</param>
    public static void UseEntityFrameworkCoreStore(this IHostApplicationBuilder builder, Action<DbContextOptionsBuilder> configure) =>
