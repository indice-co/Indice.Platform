...
public class ActivityLogOptions
{
    ...
    /// <remarks>If not set, then the <b>IdentityServer:Features:ActivityLogs</b> application setting is used.</remarks>
    ...
    public ActivityLogEventOptions Events { get; set; } = new ActivityLogEventOptions();
...
public class ActivityLogEventOptions
{
