...
public interface ICaseMessageService
{
    ...
    ///  <returns></returns>
    Task<Guid?> Send(Guid caseId, UserActor user, Message message) => Send(caseId, user, message, AuditMeta.Create(user));
    ...
    ///  <returns></returns>
    Task<Guid?> Send(Guid caseId, UserActor user, Message message, AuditMeta createdBy);
}
...
public static class ICaseMessageServiceExtensions
{
    ...
    /// <returns></returns>
    public static Task<Guid?> Send(this ICaseMessageService caseMessageService, Guid caseId, UserActor user, Exception exception, string? message = null) =>
