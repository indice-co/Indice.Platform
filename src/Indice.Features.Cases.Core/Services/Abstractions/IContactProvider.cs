...
public interface IContactProvider
{
    ...
    /// <returns></returns>
    Task<ResultSet<Contact>> GetListAsync(WorkflowActor user, ListOptions<ContactFilter> listOptions);
    ...
    Task<Contact?> GetByReferenceAsync(WorkflowActor user, string reference, string caseTypeCode);
}
