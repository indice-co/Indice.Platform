...
public interface IAdminCaseService
{
    ...
    Task<Case> GetCaseById(ClaimsPrincipal user, Guid caseId, bool? includeAttachmentData = null); // todo: can return value "Case" be null here?
    ...
    /// <param name="userMeta">The user that initiated the call, and will be self-assigned to the case.</param>
    ...
    Task<AuditMeta> AssignCase(AuditMeta userMeta, Guid caseId);
