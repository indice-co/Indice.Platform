...
/// <summary>The event that will be raised <b>after</b> the case service handles a <see cref="Message"/>.</summary>
public class CaseMessageSentEvent : ICaseEvent
{
    /// <summary>The Id of the case.</summary>
    public Guid CaseId { get; set; }
    
    /// <summary>The <see cref="Message"/> that has been sent to the case service.</summary>
    public Message Message { get; set; }

    /// <summary>Construct a new <see cref="CaseMessageSentEvent"/>.</summary>
