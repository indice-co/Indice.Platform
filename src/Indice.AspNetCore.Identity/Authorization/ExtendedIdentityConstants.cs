namespace Indice.AspNetCore.Identity
{
    ...
    public class ExtendedIdentityConstants
    {
        ...
        /// <summary>A claim type used to store temp data regarding password exporation that will be used in a partial login to identify that a user is in need for an immediate password change.</summary>
