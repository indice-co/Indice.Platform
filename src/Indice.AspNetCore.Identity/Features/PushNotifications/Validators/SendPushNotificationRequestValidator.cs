...
/// <summary>A validator for <see cref="SendPushNotificationRequestValidator"/> model.</summary>
public class SendPushNotificationRequestValidator : AbstractValidator<SendPushNotificationRequest>
{
    /// <summary>Creates a new instance of <see cref="SendPushNotificationRequestValidator"/>.</summary>
