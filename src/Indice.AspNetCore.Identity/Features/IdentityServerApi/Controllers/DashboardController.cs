...
/// <summary>A controller that provides useful information for the users.</summary>
...
internal class DashboardController : ControllerBase
{
    ...
    /// <summary>Creates a new instance of <see cref="DashboardController"/>.</summary>
    ...
    /// <summary>Displays blog posts from the official IdentityServer blog.</summary>
