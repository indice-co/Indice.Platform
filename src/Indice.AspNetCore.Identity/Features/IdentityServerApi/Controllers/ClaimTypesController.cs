...
internal class ClaimTypesController : ControllerBase
{
    ...
    /// <summary>Creates an instance of <see cref="ClaimTypesController"/>.</summary>
    ...
    /// <summary>Returns a list of <see cref="ClaimTypeInfo"/> objects containing the total number of claim types in the database and the data filtered according to the provided <see cref="ListOptions"/>.</summary>
    ...
    /// <summary>Gets a claim type by it's unique id.</summary>
    ...
    /// <summary>Creates a new claim type.</summary>
    ...
    /// <summary>Updates an existing claim type.</summary>
    ...
    /// <summary>Permanently deletes an existing claim type.</summary>
