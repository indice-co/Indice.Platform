...
namespace Indice.AspNetCore.Identity.Api.Security
{
    ...
    public static class IdentityServerApi
    {
        ...
        {
            /// <summary>
            /// A user must have the 'Admin' flag or own one of the <see cref="BasicRoleNames.Administrator"/> or <see cref="BasicRoleNames.AdminUIAdministrator"/> roles.
            /// </summary>
            public const string BeAdmin = nameof(BeAdmin);
            /// <summary>
            /// A user must have the 'Admin' flag or own one of the <see cref="BasicRoleNames.Administrator"/>, <see cref="BasicRoleNames.AdminUIAdministrator"/> or <see cref="BasicRoleNames.AdminUIUsersReader"/> roles.
            /// </summary>
            public const string BeUsersReader = nameof(BeUsersReader);
            /// <summary>
            /// A user must have the 'Admin' flag or own one of the <see cref="BasicRoleNames.Administrator"/>, <see cref="BasicRoleNames.AdminUIAdministrator"/> or <see cref="BasicRoleNames.AdminUIUsersWriter"/> roles.
            /// </summary>
            public const string BeUsersWriter = nameof(BeUsersWriter);
            /// <summary>
            /// A user must have the 'Admin' flag or own one of the <see cref="BasicRoleNames.Administrator"/>, <see cref="BasicRoleNames.AdminUIAdministrator"/> or <see cref="BasicRoleNames.AdminUIClientsReader"/> roles.
            /// </summary>
