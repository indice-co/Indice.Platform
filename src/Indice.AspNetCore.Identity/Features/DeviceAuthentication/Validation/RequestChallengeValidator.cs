...
using Indice.AspNetCore.Identity.DeviceAuthentication.Extensions;
...
namespace Indice.AspNetCore.Identity.DeviceAuthentication.Validation
{
    internal class RequestChallengeValidator
    {
        ...
        protected static ValidationResult ValidateAuthorizationCodeWithProofKeyParameters(string codeVerifier, DeviceAuthenticationCode authorizationCode) {
