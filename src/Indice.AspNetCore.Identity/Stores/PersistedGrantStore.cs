...
using Indice.Identity.EntityFramework.Stores.Mappers;
...
namespace Indice.Identity.EntityFramework.Stores
{
    /// <summary>
    ...
    public class PersistedGrantStore : IPersistedGrantStore
    {
        ...
        private IQueryable<IdentityServer4.EntityFramework.Entities.PersistedGrant> Filter(IQueryable<IdentityServer4.EntityFramework.Entities.PersistedGrant> query, PersistedGrantFilter filter) {
