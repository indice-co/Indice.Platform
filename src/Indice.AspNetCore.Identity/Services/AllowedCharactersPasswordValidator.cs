...
{
    /// <summary>
    /// A validator that checks if the characters contained in a given password are within a list of predefined allowed characters.
    /// </summary>
    public class AllowedCharactersPasswordValidator<TUser> : IPasswordValidator<TUser> where TUser : User
    {
        ...
        /// <summary>
        /// The allowed characters of a password.
        /// </summary>
