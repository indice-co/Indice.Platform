...
{
    /// <summary>Authorization policy extensions for <see cref="AuthorizationPolicyBuilder"/></summary>
    public static class AuthorizationPolicyExtensions
    {
        /// <summary>Set up the <paramref name="policyBuilder"/> to require an administrator.</summary>
