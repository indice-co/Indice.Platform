...
/// <summary>Contains methods to notify an API when a dynamic consent is altered.</summary>
public interface IParsedScopeNotificationService
{
    /// <summary>Abstracts the way that an API is notified.</summary>
...
/// <summary>Describes the way that a dynamic consent was modified.</summary>
public enum ParsedScopeNotificationType
{
    /// <summary>Grants was revoked.</summary>
    GrantsRevoked,
    /// <summary>Consent was granted.</summary>
    ConsentGranted
}
