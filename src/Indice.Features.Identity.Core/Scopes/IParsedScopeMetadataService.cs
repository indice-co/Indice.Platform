...
/// <summary>Metadata DTO class for retrieving additional information about a <see cref="ParsedScopeValue"/></summary>
...
/// <summary>A service that contains methods for resolving additional information about a parsed scope.</summary>
