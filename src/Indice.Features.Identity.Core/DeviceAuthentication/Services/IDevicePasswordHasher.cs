...
public interface IDevicePasswordHasher
{
    ...
    string HashPassword(DbUserDevice device, string password);
    ...
    PasswordVerificationResult VerifyHashedPassword(DbUserDevice device, string hashedPassword, string providedPassword);
}
