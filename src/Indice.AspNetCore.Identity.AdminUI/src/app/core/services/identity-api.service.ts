...
export interface IIdentityApiService {
     ...
     * @param id The identifier of the identity resource.
     * @return OK
     */
    getIdentityResource(id: number): Observable<IdentityResourceInfo>;
    /**
     * Permanently deletes an identity resource.
     * @param id The id of the identity resource to delete.
     * @return OK
     */
...
export class IdentityApiService implements IIdentityApiService {
     ...
     */
    getIdentityResource(id: number): Observable<IdentityResourceInfo> {
        let url_ = this.baseUrl + "/api/resources/identity/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
            ...
            if (data["errors"]) {
                ...
                for (let key in data["errors"]) {
                    if (data["errors"].hasOwnProperty(key))
                        (<any>this).errors![key] = data["errors"][key] !== undefined ? data["errors"][key] : [];
                }
            }
            this.type = data["type"];
...
export class ClientSecretRequest implements IClientSecretRequest {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.expiration = data["expiration"] ? new Date(data["expiration"].toString()) : <any>undefined;
            this.type = data["type"];
        }
    }
...
export class BlogItemInfo implements IBlogItemInfo {
    ...
    init(data?: any) {
        if (data) {
            this.title = data["title"];
            this.link = data["link"];
            this.publishDate = data["publishDate"] ? new Date(data["publishDate"].toString()) : <any>undefined;
            this.description = data["description"];
        }
    }
...
export class IdentityResourceInfo implements IIdentityResourceInfo {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.showInDiscoveryDocument = data["showInDiscoveryDocument"];
            this.nonEditable = data["nonEditable"];
            if (Array.isArray(data["allowedClaims"])) {
                this.allowedClaims = [] as any;
                for (let item of data["allowedClaims"])
...
export class ScopeInfo implements IScopeInfo {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.emphasize = data["emphasize"];
            this.showInDiscoveryDocument = data["showInDiscoveryDocument"];
            if (Array.isArray(data["userClaims"])) {
...
export class UserClientInfo implements IUserClientInfo {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.expiresAt = data["expiresAt"] ? new Date(data["expiresAt"].toString()) : <any>undefined;
            if (Array.isArray(data["scopes"])) {
                this.scopes = [] as any;
                for (let item of data["scopes"])
...
export class CreateUserClaimRequest implements ICreateUserClaimRequest {
    ...
    static fromJS(data: any): CreateUserClaimRequest {
        data = typeof data === 'object' ? data : {};
        let result = new CreateUserClaimRequest();
        result.init(data);
        return result;
    }
