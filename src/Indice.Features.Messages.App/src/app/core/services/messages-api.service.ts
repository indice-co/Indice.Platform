...
export interface IMessagesApiClient {
     ...
     * @return OK
     */
    getEventsList(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, campaignId?: string | undefined, messageId?: string | undefined, rangeStart?: Date | undefined, rangeEnd?: Date | undefined, channel?: MessageChannelKind[] | undefined, recipient?: string | null | undefined): Observable<MessageEventResultSet>;
    /**
     * Gets a result set of events.
     ...
     * @return OK
     */
    getEventsSeriesList(eventType?: string | null | undefined, channel?: MessageChannelKind | undefined, timeFrame?: SeriesTimeFrame | undefined): Observable<MessageSeriesResultSet>;
    /**
     ...
     * @return OK
     */
    getCampaigns(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, messageChannelKind?: MessageChannelKind[] | undefined, published?: boolean | null | undefined, contactId?: string | undefined, typeId?: string[] | undefined): Observable<CampaignResultSet>;
    /**
     ...
     * @return OK
     */
    getCampaignMessages(campaignId: string, page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined): Observable<RecipientResultSet>;
    /**
     ...
     * @return OK
     */
    getContacts(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, distributionListId?: string | undefined, recipientId?: string | null | undefined, email?: string | null | undefined, phoneNumber?: string | null | undefined, anonymous?: boolean | null | undefined, resolve?: boolean | null | undefined): Observable<ContactResultSet>;
    /**
     ...
     * @return OK
     */
    getContactById(contactId: string, expandPreferences?: boolean | null | undefined): Observable<Contact>;
    /**
     ...
     * @return OK
     */
    getDuplicateContacts(contactId: string, page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined): Observable<ContactResultSet>;
    /**
     ...
     * @return No Content
     */
    resolveContact(recipientId: string | null): Observable<void>;
    /**
     ...
     * @return OK
     */
    getDistributionLists(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, isSystemGenerated?: boolean | null | undefined): Observable<DistributionListResultSet>;
    /**
     ...
     * @return OK
     */
    getDistributionListContacts(distributionListId: string, page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined): Observable<ContactResultSet>;
    /**
     ...
     * @return OK
     */
    getMessageSenders(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, isDefault?: boolean | null | undefined): Observable<MessageSenderResultSet>;
    /**
     ...
     * @return OK
     */
    getMessageTypes(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined): Observable<MessageTypeResultSet>;
    /**
...
export class MessagesApiClient implements IMessagesApiClient {
    ...
    getContactById(contactId: string, expandPreferences?: boolean | null | undefined): Observable<Contact> {
        ...
        if (expandPreferences !== undefined && expandPreferences !== null)
    ...
    getDistributionLists(page?: number | null | undefined, size?: number | null | undefined, sort?: string | null | undefined, search?: string | null | undefined, isSystemGenerated?: boolean | null | undefined): Observable<DistributionListResultSet> {
        ...
        if (search !== undefined && search !== null)
            url_ += "Search=" + encodeURIComponent("" + search) + "&";
        if (isSystemGenerated !== undefined && isSystemGenerated !== null)
...
export class Campaign implements ICampaign {
    ...
    actionLink?: Hyperlink | undefined;
    published?: boolean;
...
export class CampaignDetails implements ICampaignDetails {
    attachment?: AttachmentLink | undefined;
    id?: string;
    title?: string | undefined;
    content?: { [key: string]: MessageContent; };
    actionLink?: Hyperlink | undefined;
...
export class Contact implements IContact {
    ...
    isAnonymous?: boolean;
    resolved?: boolean;
    lastResolutionDate?: Date | undefined;
...
/** Statistics about contacts in the system. */
...
export class ContactPreference implements IContactPreference {
    ...
    consentCommercialDate?: Date | undefined;
...
export class CreateContactRequest implements ICreateContactRequest {
    communicationPreference?: ContactPreference | undefined;
    recipientId?: string | undefined;
    salutation?: string | undefined;
    firstName?: string | undefined;
    lastName?: string | undefined;
...
export class MessageSeriesResultSet implements IMessageSeriesResultSet {
    summary?: MessageEventSeriesSummary | undefined;
    count?: number;
...
export class OverviewMetrics implements IOverviewMetrics {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.recipient = _data["recipient"] ? RecipientMetrics.fromJS(_data["recipient"]) : undefined as any;
            if (Array.isArray(_data["perChannel"])) {
                this.perChannel = [] as any;
                for (let item of _data["perChannel"])
                    this.perChannel!.push(ChannelMetrics.fromJS(item));
            }
            this.lastUpdateDate = _data["lastUpdateDate"] ? new Date(_data["lastUpdateDate"].toString()) : undefined as any;
            if (Array.isArray(_data["perType"])) {
                this.perType = [] as any;
                for (let item of _data["perType"])
                    this.perType!.push(VolumeOfMessageType.fromJS(item));
            }
            if (Array.isArray(_data["perTypeToday"])) {
                this.perTypeToday = [] as any;
                for (let item of _data["perTypeToday"])
                    this.perTypeToday!.push(VolumeOfMessageType.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["recipient"] = this.recipient ? this.recipient.toJSON() : undefined as any;
        if (Array.isArray(this.perChannel)) {
            data["perChannel"] = [];
            for (let item of this.perChannel)
                data["perChannel"].push(item ? item.toJSON() : undefined as any);
        }
        data["lastUpdateDate"] = this.lastUpdateDate ? this.lastUpdateDate.toISOString() : undefined as any;
        if (Array.isArray(this.perType)) {
            data["perType"] = [];
            for (let item of this.perType)
                data["perType"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.perTypeToday)) {
            data["perTypeToday"] = [];
            for (let item of this.perTypeToday)
                data["perTypeToday"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
/** Statistics about message dalivery. */
...
export class UpdateContactRequest implements IUpdateContactRequest {
    ...
    preference?: ContactPreference | undefined;
...
export class VolumeOfMessageType implements IVolumeOfMessageType {
    total?: number;
    rate?: number;
    info?: MessageType;

    constructor(data?: IVolumeOfMessageType) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.info = _data["info"] ? MessageType.fromJS(_data["info"]) : undefined as any;
        }
    }

    static fromJS(data: any): VolumeOfMessageType {
        data = typeof data === 'object' ? data : {};
        let result = new VolumeOfMessageType();
        result.init(data);
        return result;
    }
...
export interface IVolumeOfMessageType {
    total?: number;
    rate?: number;
    info?: MessageType;
}
