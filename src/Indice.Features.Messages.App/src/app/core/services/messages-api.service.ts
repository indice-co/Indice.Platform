...
export interface IMessagesApiClient {
     ...
     * @return OK
     */
    getCampaignStatus(campaignId: string): Observable<void>;
    /**
     ...
     * @return OK
     */
    getDistributionLists(page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined): Observable<DistributionListResultSet>;
    /**
...
export class MessagesApiClient implements IMessagesApiClient {
     ...
     */
    getCampaignStatus(campaignId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/campaigns/{campaignId}/status";
        if (campaignId === undefined || campaignId === null)
            throw new Error("The parameter 'campaignId' must be defined.");
        url_ = url_.replace("{campaignId}", encodeURIComponent("" + campaignId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCampaignStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processGetCampaignStatus(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
