...
export interface IMediaApiClient {
     ...
     * @return Created
     */
    createFolder(body: CreateFolderRequest): Observable<string>;
    /**
     ...
     * @return Created
     */
    uploadFile(folderId?: string | null | undefined, file?: FileParameter | undefined): Observable<string>;
    /**
...
export class MediaApiClient implements IMediaApiClient {
    ...
    protected processCreateFolder(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
