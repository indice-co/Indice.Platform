...
export interface IMediaApiClient {
     ...
     * @return OK
     */
    downloadFile(path: string, size?: number | undefined): Observable<FileResponse | null>;
    /**
     * Retrieves an existing file.
     * @return OK
     */
    getFile(fileGuid: string, format: string): Observable<FileResponse | null>;
    /**
     ...
     * @return OK
     */
    uploadFile(folderId?: string | null | undefined, files?: FileParameter[] | null | undefined): Observable<UploadFileResponse>;
}
