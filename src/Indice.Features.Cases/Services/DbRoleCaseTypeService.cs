...
{
    internal class DbRoleCaseTypeService : ICaseAuthorizationService
    {
        private readonly CasesDbContext _dbContext;
        private readonly IDistributedCache _distributedCache;
        private readonly string _roleCaseTypesCacheKey = $"{nameof(DbRoleCaseTypeService)}.roleCaseTypes";

        public DbRoleCaseTypeService(
