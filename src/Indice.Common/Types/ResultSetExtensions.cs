...
/// <summary>
/// Extension methods over collection types that produce <see cref="ResultSet{T}"/>.
/// </summary>
public static class ResultSetExtensions
{
    /// <summary>
    /// Creates a <see cref="ResultSet{T}"/> out of the current <seealso cref="IList{T}"/>. 
    /// </summary>
    ...
    /// <summary>
    /// Creates a <see cref="ResultSet{T}"/> out of the current queryable. This operation executes and materialises the queryable.
    /// </summary>
    /// <typeparam name="T">The type to contain in the result items.</typeparam>
