...
public sealed class AzureConnectionString : ConnectionString
{
    ...
    public AzureConnectionString(string connectionString) : base(connectionString) { }
