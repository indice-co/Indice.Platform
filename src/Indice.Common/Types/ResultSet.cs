...
/// <summary>Α collection wrapper that encapsulates the results of an API call or operation. Used usually for paginated results.</summary>
/// <typeparam name="T"></typeparam>
public class ResultSet<T>
{
    /// <summary>Constructs the <see cref="ResultSet{T}"/>.</summary>
    public ResultSet() { }
...
{
    /// <summary>Constructs the <see cref="ResultSet{T, TSummary}"/>.</summary>
