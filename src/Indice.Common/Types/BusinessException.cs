...
{
    /// <summary>
    /// Used to propagate business information upwards through the application layers.
    /// </summary>
    public class BusinessException : Exception
    {
        ...
        /// <summary>
        /// Creates a new business exception with the specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public BusinessException(string message) : base(message) { }

        /// <summary>
        /// Creates a new business exception with the specified error message and a list of errors.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
