...
namespace Indice.Services
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsServiceException"/> class.
        /// </summary>
        public SmsServiceException() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SmsServiceException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public SmsServiceException(string message) : base(message) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="SmsServiceException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
    ...
    /// <summary>
    /// Settings class for configuring SMS service clients.
    /// </summary>
