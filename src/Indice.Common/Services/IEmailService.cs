...
public interface IEmailService
{
    ...
    /// <param name="from">Optional email address in the form field. Defaults to the confguration values <strong>Email:Sender</strong> and <strong>Email:SenderName</strong>.</param>
