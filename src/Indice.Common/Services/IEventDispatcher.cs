...
namespace Indice.Services
{
    ...
    public interface IEventDispatcher
    {
        ...
        /// <param name="initialVisibilityDelay">Delays the sending of payload to the queue for the specified amount of time. The maximum delay can reach up to 7 days.</param>
        Task RaiseEventAsync<TEvent>(TEvent payload, ClaimsPrincipal actingPrincipal = null, TimeSpan? initialVisibilityDelay = null) where TEvent : class, new();
    }
}
