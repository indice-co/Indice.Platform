...
namespace Indice.Services
{
    ...
    public interface ISmsServiceFactory {
        ...
        /// an <see cref="NotSupportedException"/> will be thrown.
        /// </summary>
    ...
    /// <summary>
    /// Default sms service factory
    /// </summary>
    public class DefaultSmsServiceFactory : ISmsServiceFactory
    {
        /// <summary>
        /// Constructs the factory given all the available implementations of the <see cref="ISmsService"/>.
        /// </summary>
        ...
        /// <summary>
        /// Available <see cref="ISmsService"/> implementations
        /// </summary>
