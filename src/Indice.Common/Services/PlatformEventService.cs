...
namespace Indice.Services
{
    ...
    public class PlatformEventService : IPlatformEventService
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="PlatformEventService"/>.
        /// </summary>
        ...
        public async Task Publish<TEvent>(TEvent @event) where TEvent : IPlatformEvent {
            var handlers = (IEnumerable<IPlatformEventHandler<TEvent>>)_serviceProvider.GetService(typeof(IEnumerable<IPlatformEventHandler<TEvent>>)) ?? Enumerable.Empty<IPlatformEventHandler<TEvent>>();
