...
namespace Indice.Extensions
{
    ...
    public static class UrlExtensions
    {
        ...
        /// <summary>
        /// Converts the specified URL safe string, which encodes binary data as base-64 digits, to an equivalent 8-bit unsigned integer array.
        /// </summary>
        ...
        /// <summary>
        /// Converts an array of 8-bit unsigned integers to its equivalent string representation, suitable to be used in a URL, that is encoded with base-64 digits.
        /// </summary>
        ...
        /// <summary>
        /// Converts a string to its equivalent string representation, suitable to be used in a URL, that is encoded with base-64 digits.
        /// </summary>
        ...
        /// <summary>
        /// Converts a string, which encodes binary data as base-64 digits, to its equivalent string representation that is encoded with base-64 digits.
        /// </summary>
        /// <param name="encoded">The string to convert.</param>
