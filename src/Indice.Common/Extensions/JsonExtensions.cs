...
/// <summary>Extension methods related to JSON serialization.</summary>
public static partial class JsonExtensions
{
    /// <summary>Converts a <see cref="JsonElement"/> to the given type <typeparamref name="T"/>.</summary>
    ...
    /// <summary>Converts a <see cref="JsonDocument"/> to the given type <typeparamref name="T"/>.</summary>
    /// <typeparam name="T">The type to convert.</typeparam>
    ...
    /// <summary>Converts a <see cref="JsonElement"/> to the given type <paramref name="returnType"/>.</summary>
    /// <param name="element">A specific value of the JSON content.</param>
    ...
    /// <summary>Converts a <see cref="JsonDocument"/> to the given type <paramref name="returnType"/>.</summary>
    /// <param name="document">The JSON content.</param>
    /// <param name="returnType">The type to return.</param>
    /// <param name="options">Provides options to be used with <see cref="JsonSerializer"/>.</param>
