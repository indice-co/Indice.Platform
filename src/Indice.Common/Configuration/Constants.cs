...
/// <summary>Commonly used sizes for database fields.</summary>
public class TextSizePresets
{
    /// <summary>Size 8.</summary>
...
/// <summary>Contains names for custom headers used.</summary>
public class CustomHeaderNames 
{
    /// <summary>Header name for requests that need to contain an antiforgery token.</summary>
