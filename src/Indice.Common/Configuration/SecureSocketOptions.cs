...
namespace Indice.Configuration
{
    ...
    public enum SecureSocketOptions
    {
        ...
        None = 0,
        /// <summary>
        /// Allow the <see cref="IEmailService"/> to decide which SSL or TLS options to use (default). If the server does not support SSL or TLS, then the connection will continue without any encryption.
        /// </summary>
        Auto = 1,
        /// <summary>
