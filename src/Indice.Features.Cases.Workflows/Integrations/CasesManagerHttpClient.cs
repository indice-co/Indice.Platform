...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CasesAttachmentLink> AttachFileAsync(System.Guid caseId, FileParameter file, string comment, string dataRootKey, string actorId, string actorReference, string actorGroupId, string actorName, string actorTin, string actorEmail, string actorCurrentCulture) {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CasesAttachmentLink> AttachFileAsync(System.Guid caseId, FileParameter file, string comment, string dataRootKey, string actorId, string actorReference, string actorGroupId, string actorName, string actorTin, string actorEmail, string actorCurrentCulture, System.Threading.CancellationToken cancellationToken) {
            if (caseId == null)
                throw new System.ArgumentNullException("caseId");
        ...
        /// <returns>No Content</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task PatchMetadataAsync(System.Guid caseId, System.Collections.Generic.IDictionary<string, string> body) {
        ...
        /// <returns>No Content</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task PatchMetadataAsync(System.Guid caseId, System.Collections.Generic.IDictionary<string, string> body, System.Threading.CancellationToken cancellationToken) {
            if (caseId == null)
                throw new System.ArgumentNullException("caseId");
        ...
        /// <returns>No Content</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task SendMessageAsync(System.Guid caseId, FileParameter file, string actorId, string actorReference, string actorGroupId, string actorName, string actorTin, string actorEmail, string actorCurrentCulture, System.Guid? replyToCommentId, string checkpointTypeName, bool? privateComment, string comment, string fileName, object data) {
            return SendMessageAsync(caseId, file, actorId, actorReference, actorGroupId, actorName, actorTin, actorEmail, actorCurrentCulture, replyToCommentId, checkpointTypeName, privateComment, comment, fileName, data, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>No Content</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task SendMessageAsync(System.Guid caseId, FileParameter file, string actorId, string actorReference, string actorGroupId, string actorName, string actorTin, string actorEmail, string actorCurrentCulture, System.Guid? replyToCommentId, string checkpointTypeName, bool? privateComment, string comment, string fileName, object data, System.Threading.CancellationToken cancellationToken) {
            if (caseId == null)
                throw new System.ArgumentNullException("caseId");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<NotificationSubscriptionResultSet> GetCaseTypeSubscribersAsync(string caseTypeCode, int? page, int? size, string sort, string search, System.Collections.Generic.IEnumerable<string> groupIds, System.Collections.Generic.IEnumerable<string> emails) {
            return GetCaseTypeSubscribersAsync(caseTypeCode, page, size, sort, search, groupIds, emails, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<NotificationSubscriptionResultSet> GetCaseTypeSubscribersAsync(string caseTypeCode, int? page, int? size, string sort, string search, System.Collections.Generic.IEnumerable<string> groupIds, System.Collections.Generic.IEnumerable<string> emails, System.Threading.CancellationToken cancellationToken) {
            ...
            try {
                using (var request_ = new System.Net.Http.HttpRequestMessage()) {
                    ...
                    if (emails != null) {
                        foreach (var item_ in emails) { urlBuilder_.Append(System.Uri.EscapeDataString("emails")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append('&'); }
                    }
                    urlBuilder_.Length--;
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task CreateRulesAsync(string caseType, string workflowName, System.Collections.Generic.IEnumerable<System.Collections.Generic.IDictionary<string, object>> body)
        {
            return CreateRulesAsync(caseType, workflowName, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CreateRulesAsync(string caseType, string workflowName, System.Collections.Generic.IEnumerable<System.Collections.Generic.IDictionary<string, object>> body, System.Threading.CancellationToken cancellationToken)
        {
            if (caseType == null)
                throw new System.ArgumentNullException("caseType");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/manage/workflow-integration/create-rules"
                    urlBuilder_.Append("api/manage/workflow-integration/create-rules");
                    urlBuilder_.Append('?');
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task CreateWorkflowAsync(string caseType, string workflowName)
        {
            return CreateWorkflowAsync(caseType, workflowName, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CreateWorkflowAsync(string caseType, string workflowName, System.Threading.CancellationToken cancellationToken)
        {
            if (caseType == null)
                throw new System.ArgumentNullException("caseType");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/manage/workflow-integration/create-workflow"
                    urlBuilder_.Append("api/manage/workflow-integration/create-workflow");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("caseType")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(caseType, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Append(System.Uri.EscapeDataString("workflowName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(workflowName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> RunWorkflowAsync(string caseType, string workflowName, System.Collections.Generic.IEnumerable<object> body)
        {
            return RunWorkflowAsync(caseType, workflowName, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> RunWorkflowAsync(string caseType, string workflowName, System.Collections.Generic.IEnumerable<object> body, System.Threading.CancellationToken cancellationToken)
        {
            if (caseType == null)
                throw new System.ArgumentNullException("caseType");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/manage/workflow-integration/run-workflow"
                    urlBuilder_.Append("api/manage/workflow-integration/run-workflow");
                    urlBuilder_.Append('?');
                    urlBuilder_.Append(System.Uri.EscapeDataString("caseType")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(caseType, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Append(System.Uri.EscapeDataString("workflowName")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(workflowName, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    urlBuilder_.Length--;
        ...
        /// <summary>
        /// Get Subscriptions by filters.
        /// </summary>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationSubscription>> GetSubscriptionsByFiltersAsync(int? page, int? size, string sort, string search, System.Collections.Generic.IEnumerable<string> email, System.Collections.Generic.IEnumerable<string> groupId, System.Collections.Generic.IEnumerable<System.Guid> caseTypeIds)
        {
            return GetSubscriptionsByFiltersAsync(page, size, sort, search, email, groupId, caseTypeIds, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationSubscription>> GetSubscriptionsByFiltersAsync(int? page, int? size, string sort, string search, System.Collections.Generic.IEnumerable<string> email, System.Collections.Generic.IEnumerable<string> groupId, System.Collections.Generic.IEnumerable<System.Guid> caseTypeIds, System.Threading.CancellationToken cancellationToken)
        {
            if (email == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/manage/workflow-integration/subscriptions"
                    urlBuilder_.Append("api/manage/workflow-integration/subscriptions");
                    urlBuilder_.Append('?');
                    if (page != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("Page")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(page, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial record Subscriber
    {
