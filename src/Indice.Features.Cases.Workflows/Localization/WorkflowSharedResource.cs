...
namespace Indice.Features.Cases.Workflows.Localization;

/// <summary>Shared resource service for localizing string to the consumer's module.</summary>
public class WorkflowSharedResourceService
{
    ...
    public WorkflowSharedResourceService(IStringLocalizerFactory factory, string? assemblyName = null) {
        if (assemblyName == null) {
            var type = typeof(WorkflowSharedResource);
            assemblyName = type.Assembly.GetName().Name!;
        }
        _localizer = factory.Create(nameof(WorkflowSharedResource), assemblyName);
    }
...
public class WorkflowSharedResource { }
