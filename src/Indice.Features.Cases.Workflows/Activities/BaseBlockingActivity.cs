...
public abstract class BaseBlockingActivity : BaseCaseActivity
{
    protected BaseBlockingActivity(CasesHttpClient casesClient) : base(casesClient) { }
    ...
    public abstract Task<IActivityExecutionResult> OnExecuteInternalAsync(ActivityExecutionContext context);
}