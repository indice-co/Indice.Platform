...
/// <summary>Models access to an API resource.</summary>
public class ApiScopeInfo
{
    /// <summary>Unique identifier for the scope.</summary>
    ...
    /// <summary>List of associated user claims that should be included when a resource is requested.</summary>
    public IEnumerable<string>? UserClaims { get; set; }
}

/// <summary>Translation object for type <see cref="ApiScopeInfo"/>.</summary>
