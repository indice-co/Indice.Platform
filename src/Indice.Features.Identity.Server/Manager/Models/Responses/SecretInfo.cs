...
/// <summary>Models a secret.</summary>
...
{
    /// <summary>The identifier for the API secret.</summary>
    public int Id { get; set; }
    /// <summary>Indicates if the secret is expired.</summary>
    public bool IsExpired => Expiration.HasValue && Expiration.Value < DateTime.UtcNow;
}

/// <summary>Models an API secret used for the introspection endpoint. The API can authenticate with introspection using the API name and secret.</summary>
public class ApiSecretInfo : SecretInfo { }

/// <summary>Models an Client secret used in flows that require this.</summary>
