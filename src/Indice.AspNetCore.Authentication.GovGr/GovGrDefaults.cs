...
{
    /// <summary>
    /// Default values for authenticating using gov.gr.
    /// </summary>
    public class GovGrDefaults
    {
        /// <summary>
        /// The default scheme for gov.gr authentication. Defaults to <c>GovGr</c>.
        /// </summary>
        public const string AuthenticationScheme = "GovGr";
        /// <summary>
        /// The default display name for gov.gr authentication. Defaults to <c>Sign in with GovGr</c>.
        /// </summary>
