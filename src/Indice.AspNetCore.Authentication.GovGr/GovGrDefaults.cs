...
public class GovGrDefaults
{
    ...
    public static readonly string AuthorizationEndpoint = "https://oauth2.gsis.gr/oauth2server/oauth/authorize";
    /// <summary>The OAuth endpoint used to exchange access tokens.</summary>
    public static readonly string TokenEndpoint = "https://oauth2.gsis.gr/oauth2server/oauth/token";
    ...
    public static readonly string Authority = "https://oauth2.gsis.gr";
    ...
    public static readonly string UserInformationEndpoint = "https://oauth2.gsis.gr/oauth2server/userinfo";
