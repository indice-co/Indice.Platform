...
public class RiskDbContext : DbContext, IAppSettingsDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<RiskEvent>().Property(x => x.Location).HasMaxLength(TextSizePresets.M256);
        modelBuilder.Entity<RiskEvent>().Property(x => x.SessionId).HasMaxLength(TextSizePresets.M128);
