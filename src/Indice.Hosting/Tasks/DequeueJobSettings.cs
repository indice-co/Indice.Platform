...
{
    /// <summary>
    /// Contains meta-data about a job to execute.
    /// </summary>
    internal class DequeueJobSettings
    {
        ...
        /// <summary>
        /// The time interval between two attempts to dequeue new items. Measured in milliseconds
        /// </summary>
        public double PollingInterval { get; set; } = 300;
        /// <summary>
        /// The maximum time interval between two attempts to dequeue new items. Measured in milliseconds
        /// </summary>
