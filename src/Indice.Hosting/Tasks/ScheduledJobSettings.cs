...
/// <summary>Job schedule settings. Describes what to execute and when.</summary>
public class ScheduledJobSettings
{
    /// <summary>Constructs the schedule given a job type and the cron expression.</summary>
    ...
    /// <summary>The CLR type for the job.</summary>
    public Type JobHandlerType { get; }
    /// <summary>The type of the job state object.</summary>
