...
export class CheckipointTypeTranslation implements ICheckipointTypeTranslation {
    /** The title of the checkpoint type. */
    title?: string | undefined;
    /** The checkpoint type description. */
    description?: string | undefined;

    constructor(data?: ICheckipointTypeTranslation) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CheckipointTypeTranslation {
        data = typeof data === 'object' ? data : {};
        let result = new CheckipointTypeTranslation();
        result.init(data);
        return result;
    }
...
/** The Translation of the checkpoint type. */
export interface ICheckipointTypeTranslation {
    /** The title of the checkpoint type. */
    title?: string | undefined;
    /** The checkpoint type description. */
    description?: string | undefined;
...
export class CheckpointType implements ICheckpointType {
    ...
    description?: string | undefined;
    /** A type that models the translation of an object. */
    translations?: { [key: string]: CheckipointTypeTranslation; } | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["translations"]) {
                ...
                for (let key in _data["translations"]) {
                    if (_data["translations"].hasOwnProperty(key))
                        (<any>this.translations)![key] = _data["translations"][key] ? CheckipointTypeTranslation.fromJS(_data["translations"][key]) : new CheckipointTypeTranslation();
                }
            }
        }
    }
