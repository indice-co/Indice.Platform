...
export interface ICasesApiService {
     ...
     */
    downloadAttachment(attachmentId: string): Observable<void>;
    /**
     * Get case types.
     * @param canCreate (optional) 
     * @return OK
     */
    getAdminCaseTypes(canCreate?: boolean | undefined): Observable<CaseTypePartialResultSet>;
    /**
     * Create new case type.
     * @return No Content
     */
    caseTypesPOST(body: CaseTypeRequest): Observable<void>;
    /**
     * Get a specific Case Type by Id.
     * @return OK
     */
    caseTypesGET(caseTypeId: string): Observable<CaseType>;
    /**
     * Update a specific Case Type.
     * @return OK
     */
    caseTypesPUT(caseTypeId: string, body: CaseTypeRequest): Observable<CaseType>;
    /**
     * Delete a specific Case Type.
     * @return No Content
     */
    caseTypesDELETE(caseTypeId: string): Observable<void>;
    /**
     ...
     */
    downloadCasePdf(caseId: string): Observable<void>;
    /**
...
export class CasesApiService implements ICasesApiService {
    ...
    getAdminCaseTypes(canCreate?: boolean | undefined): Observable<CaseTypePartialResultSet> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAdminCaseTypes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAdminCaseTypes(response_ as any);
                } catch (e) {
    ...
    protected processGetAdminCaseTypes(response: HttpResponseBase): Observable<CaseTypePartialResultSet> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    caseTypesPOST(body: CaseTypeRequest): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCaseTypesPOST(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCaseTypesPOST(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCaseTypesPOST(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    caseTypesGET(caseTypeId: string): Observable<CaseType> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCaseTypesGET(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCaseTypesGET(response_ as any);
                } catch (e) {
    ...
    protected processCaseTypesGET(response: HttpResponseBase): Observable<CaseType> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    caseTypesPUT(caseTypeId: string, body: CaseTypeRequest): Observable<CaseType> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCaseTypesPUT(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCaseTypesPUT(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CaseType>;
                }
            } else
    ...
    protected processCaseTypesPUT(response: HttpResponseBase): Observable<CaseType> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    caseTypesDELETE(caseTypeId: string): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCaseTypesDELETE(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCaseTypesDELETE(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCaseTypesDELETE(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processDownloadCasePdf(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
