...
export interface ICasesApiService {
     ...
     * @return No Content
     */
    replaceAccessRulesUser(caseId: string, body: ReplaceCaseAccessRuleUserRequest): Observable<void>;
    /**
     ...
     * @return OK
     */
    getDecisions(caseTypeCode: string): Observable<DecisionsResponse>;
    /**
     * SetDecisionRules
     * @return No Content
     */
    setRules(caseTypeCode: string, body: DecisionTable): Observable<void>;
    /**
    ...
    /**
     * Fetch contact by contact.reference number.
     * @return OK
     */
    getContactByReference(reference: string): Observable<Contact>;
    /**
...
export class CasesApiService implements ICasesApiService {
    ...
    updateAccessRule(ruleId: string, accessLevel: number): Observable<void> {
        ...
        if (accessLevel === undefined || accessLevel === null)
            throw new globalThis.Error("The parameter 'accessLevel' must be defined.");
     ...
     */
    createAccessRulesBatch(body: AddAccessRuleRequest[]): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/access-rules/batch";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getCaseTypesList(canCreate?: boolean | undefined): Observable<CaseTypePartialResultSet> {
        ...
        if (canCreate === null)
            throw new globalThis.Error("The parameter 'canCreate' cannot be null.");
    ...
    getCaseTypeById(caseTypeId: string): Observable<CaseType> {
        ...
        if (caseTypeId === undefined || caseTypeId === null)
            throw new globalThis.Error("The parameter 'caseTypeId' must be defined.");
    ...
    getCases(page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined, ownerIds?: string[] | undefined, ownerNames?: string[] | undefined, ownerTins?: string[] | undefined, from?: Date | undefined, to?: Date | undefined, showAll?: boolean | undefined, caseTypeCodes?: string[] | undefined, checkpointTypeCodes?: string[] | undefined, groupIds?: string[] | undefined, metadata?: string[] | undefined, referenceNumbers?: string[] | undefined, data?: string[] | undefined, includeData?: boolean | undefined, assignedTo?: string | undefined): Observable<CasePartialResultSet> {
        ...
        if (showAll === null)
            throw new globalThis.Error("The parameter 'showAll' cannot be null.");
        else if (showAll !== undefined)
            url_ += "ShowAll=" + encodeURIComponent("" + showAll) + "&";
        if (caseTypeCodes === null)
            throw new globalThis.Error("The parameter 'caseTypeCodes' cannot be null.");
        ...
        if (checkpointTypeCodes === null)
            throw new globalThis.Error("The parameter 'checkpointTypeCodes' cannot be null.");
        ...
        if (groupIds === null)
            throw new globalThis.Error("The parameter 'groupIds' cannot be null.");
        else if (groupIds !== undefined)
            groupIds && groupIds.forEach(item => { url_ += "GroupIds=" + encodeURIComponent("" + item) + "&"; });
        if (metadata === null)
            throw new globalThis.Error("The parameter 'metadata' cannot be null.");
        else if (metadata !== undefined)
            metadata && metadata.forEach(item => { url_ += "Metadata=" + encodeURIComponent("" + item) + "&"; });
        if (referenceNumbers === null)
            throw new globalThis.Error("The parameter 'referenceNumbers' cannot be null.");
        ...
        if (includeData === null)
            throw new globalThis.Error("The parameter 'includeData' cannot be null.");
        else if (includeData !== undefined)
            url_ += "IncludeData=" + encodeURIComponent("" + includeData) + "&";
        if (assignedTo === null)
            throw new globalThis.Error("The parameter 'assignedTo' cannot be null.");
    ...
    getCaseById(caseId: string, fetchPublicData?: boolean | undefined): Observable<Case> {
        ...
        if (fetchPublicData === null)
            throw new globalThis.Error("The parameter 'fetchPublicData' cannot be null.");
        else if (fetchPublicData !== undefined)
            url_ += "fetchPublicData=" + encodeURIComponent("" + fetchPublicData) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    updateCaseAccessRulesBatch(caseId: string, body: AddCaseAccessRuleRequest[]): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseId}/access-rules/batch";
        if (caseId === undefined || caseId === null)
            throw new globalThis.Error("The parameter 'caseId' must be defined.");
        url_ = url_.replace("{caseId}", encodeURIComponent("" + caseId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    replaceAccessRulesUser(caseId: string, body: ReplaceCaseAccessRuleUserRequest): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseId}/access-rules/replace";
        if (caseId === undefined || caseId === null)
            throw new globalThis.Error("The parameter 'caseId' must be defined.");
        url_ = url_.replace("{caseId}", encodeURIComponent("" + caseId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processReplaceAccessRulesUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processReplaceAccessRulesUser(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processReplaceAccessRulesUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    getAttachmentByField(caseId: string, fieldName: string): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseId}/attachments/{fieldName}";
        if (caseId === undefined || caseId === null)
            throw new globalThis.Error("The parameter 'caseId' must be defined.");
        url_ = url_.replace("{caseId}", encodeURIComponent("" + caseId));
        if (fieldName === undefined || fieldName === null)
            throw new globalThis.Error("The parameter 'fieldName' must be defined.");
     ...
     */
    initializeCaseData(caseId: string): Observable<any> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseId}/data/init";
        if (caseId === undefined || caseId === null)
            throw new globalThis.Error("The parameter 'caseId' must be defined.");
        url_ = url_.replace("{caseId}", encodeURIComponent("" + caseId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processInitializeCaseData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processInitializeCaseData(response_ as any);
                } catch (e) {
    ...
    protected processInitializeCaseData(response: HttpResponseBase): Observable<any> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    publishCasePrivateData(caseId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseId}/publish-private-data";
        if (caseId === undefined || caseId === null)
            throw new globalThis.Error("The parameter 'caseId' must be defined.");
        url_ = url_.replace("{caseId}", encodeURIComponent("" + caseId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPublishCasePrivateData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPublishCasePrivateData(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processPublishCasePrivateData(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    getDecisions(caseTypeCode: string): Observable<DecisionsResponse> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseTypeCode}/get-decisions";
        if (caseTypeCode === undefined || caseTypeCode === null)
            throw new globalThis.Error("The parameter 'caseTypeCode' must be defined.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDecisions(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDecisions(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<DecisionsResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DecisionsResponse>;
        }));
    }

    protected processGetDecisions(response: HttpResponseBase): Observable<DecisionsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DecisionsResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     */
    setRules(caseTypeCode: string, body: DecisionTable): Observable<void> {
        let url_ = this.baseUrl + "/api/manage/cases/{caseTypeCode}/set-rules";
        if (caseTypeCode === undefined || caseTypeCode === null)
            throw new globalThis.Error("The parameter 'caseTypeCode' must be defined.");
        url_ = url_.replace("{caseTypeCode}", encodeURIComponent("" + caseTypeCode));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetRules(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetRules(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processSetRules(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getContacts(reference?: string | undefined, caseTypeCode?: string | undefined, page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined): Observable<ContactResultSet> {
        ...
        if (caseTypeCode === null)
            throw new globalThis.Error("The parameter 'caseTypeCode' cannot be null.");
     ...
     */
    getContactByReference(reference: string): Observable<Contact> {
        let url_ = this.baseUrl + "/api/manage/integrations/contacts/{reference}";
        if (reference === undefined || reference === null)
            throw new globalThis.Error("The parameter 'reference' must be defined.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetContactByReference(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetContactByReference(response_ as any);
                } catch (e) {
    ...
    protected processGetContactByReference(response: HttpResponseBase): Observable<Contact> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getLookup(lookupName: string, page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined, filterTerms?: string[] | undefined): Observable<LookupItemResultSet> {
        ...
        if (lookupName === undefined || lookupName === null)
            throw new globalThis.Error("The parameter 'lookupName' must be defined.");
        ...
        if (search === null)
            ...
            url_ += "Search=" + encodeURIComponent("" + search) + "&";
        if (filterTerms === null)
            throw new globalThis.Error("The parameter 'filterTerms' cannot be null.");
    ...
    getCaseReport(reportTag: ReportTag): Observable<GroupByReportResult[]> {
        ...
        if (reportTag === undefined || reportTag === null)
            throw new globalThis.Error("The parameter 'reportTag' must be defined and cannot be null.");
        else
...
export class AuditMeta implements IAuditMeta {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.when = _data["when"] ? new Date(_data["when"].toString()) : undefined as any;
        }
    }
...
export class Case implements ICase {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.createdByWhen = _data["createdByWhen"] ? new Date(_data["createdByWhen"].toString()) : undefined as any;
            this.createdById = _data["createdById"];
            this.createdByEmail = _data["createdByEmail"];
            this.createdByName = _data["createdByName"];
            this.caseType = _data["caseType"] ? CaseTypePartial.fromJS(_data["caseType"]) : undefined as any;
            if (_data["metadata"]) {
            ...
            this.checkpointType = _data["checkpointType"] ? CheckpointType.fromJS(_data["checkpointType"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["createdByWhen"] = this.createdByWhen ? this.createdByWhen.toISOString() : undefined as any;
        data["createdById"] = this.createdById;
        data["createdByEmail"] = this.createdByEmail;
        data["createdByName"] = this.createdByName;
        data["caseType"] = this.caseType ? this.caseType.toJSON() : undefined as any;
        if (this.metadata) {
            data["metadata"] = {};
        ...
        data["checkpointType"] = this.checkpointType ? this.checkpointType.toJSON() : undefined as any;
        data["data"] = this.data;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.customActions)) {
            ...
            for (let item of this.customActions)
                data["customActions"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
            ...
            if (_data["translations"]) {
                ...
                for (let key in _data["translations"]) {
                    if (_data["translations"].hasOwnProperty(key))
                        (this.translations as any)![key] = _data["translations"][key] ? CaseTypeTranslation.fromJS(_data["translations"][key]) : new CaseTypeTranslation();
                }
            }
            if (_data["layoutTranslations"]) {
                ...
                for (let key in _data["layoutTranslations"]) {
                    if (_data["layoutTranslations"].hasOwnProperty(key))
                        (this.layoutTranslations as any)![key] = _data["layoutTranslations"][key];
                }
            }
    ...
    toJSON(data?: any) {
        ...
        if (this.layoutTranslations) {
            ...
            for (let key in this.layoutTranslations) {
                if (this.layoutTranslations.hasOwnProperty(key))
                    (data["layoutTranslations"] as any)[key] = (this.layoutTranslations as any)[key];
            }
        }
        data["tags"] = this.tags;
        ...
        if (Array.isArray(this.checkpointTypes)) {
            ...
            for (let item of this.checkpointTypes)
                data["checkpointTypes"].push(item ? item.toJSON() : undefined as any);
        }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["translations"]) {
                ...
                for (let key in _data["translations"]) {
                    if (_data["translations"].hasOwnProperty(key))
                        (this.translations as any)![key] = _data["translations"][key] ? CategoryTranslation.fromJS(_data["translations"][key]) : new CategoryTranslation();
                }
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["translations"]) {
                ...
                for (let key in _data["translations"]) {
                    if (_data["translations"].hasOwnProperty(key))
                        (this.translations as any)![key] = _data["translations"][key] ? CheckpointTypeTranslation.fromJS(_data["translations"][key]) : new CheckpointTypeTranslation();
                }
            }
        }
    }
...
export class Comment implements IComment {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.private = _data["private"];
            this.attachment = _data["attachment"] ? CasesAttachmentLink.fromJS(_data["attachment"]) : undefined as any;
            this.replyToComment = _data["replyToComment"] ? Comment.fromJS(_data["replyToComment"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["replyToComment"] = this.replyToComment ? this.replyToComment.toJSON() : undefined as any;
        return data;
    }
}
...
export class CreateDraftCaseRequest implements ICreateDraftCaseRequest {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.groupId = _data["groupId"];
            this.owner = _data["owner"] ? ContactMeta.fromJS(_data["owner"]) : undefined as any;
            if (_data["metadata"]) {
                this.metadata = {} as any;
                for (let key in _data["metadata"]) {
                    if (_data["metadata"].hasOwnProperty(key))
...
export class CustomCaseAction implements ICustomCaseAction {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.successMessage = _data["successMessage"] ? SuccessMessage.fromJS(_data["successMessage"]) : undefined as any;
            this.description = _data["description"];
    ...
    toJSON(data?: any) {
        ...
        data["successMessage"] = this.successMessage ? this.successMessage.toJSON() : undefined as any;
        data["description"] = this.description;
...
export class DecisionDefinition implements IDecisionDefinition {
    name?: string | undefined;
    variables?: DecisionVariableDefinition[] | undefined;

    constructor(data?: IDecisionDefinition) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["variables"])) {
                ...
                for (let item of _data["variables"])
                    this.variables!.push(DecisionVariableDefinition.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DecisionDefinition {
        data = typeof data === 'object' ? data : {};
        let result = new DecisionDefinition();
        result.init(data);
        return result;
    }
...
export class DecisionRule implements IDecisionRule {
    ruleName?: string | undefined;
    conditions?: RuleCondition[] | undefined;
    successEvent?: string | undefined;
    errorMessage?: string | undefined;

    constructor(data?: IDecisionRule) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.successEvent = _data["successEvent"];
            this.errorMessage = _data["errorMessage"];
        }
    }

    static fromJS(data: any): DecisionRule {
        data = typeof data === 'object' ? data : {};
        let result = new DecisionRule();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["successEvent"] = this.successEvent;
...
export class DecisionsResponse implements IDecisionsResponse {
    decisionDefinitions?: DecisionDefinition[] | undefined;
    decisionTable?: DecisionTable;

    constructor(data?: IDecisionsResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["decisionDefinitions"])) {
                this.decisionDefinitions = [] as any;
                for (let item of _data["decisionDefinitions"])
                    this.decisionDefinitions!.push(DecisionDefinition.fromJS(item));
            }
            this.decisionTable = _data["decisionTable"] ? DecisionTable.fromJS(_data["decisionTable"]) : undefined as any;
        }
    }

    static fromJS(data: any): DecisionsResponse {
        data = typeof data === 'object' ? data : {};
        let result = new DecisionsResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.decisionDefinitions)) {
            data["decisionDefinitions"] = [];
            for (let item of this.decisionDefinitions)
                data["decisionDefinitions"].push(item ? item.toJSON() : undefined as any);
        }
        data["decisionTable"] = this.decisionTable ? this.decisionTable.toJSON() : undefined as any;
        return data;
    }
}
...
export class DecisionTable implements IDecisionTable {
    ...
    constructor(data?: IDecisionTable) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.decisionName = _data["decisionName"];
            if (Array.isArray(_data["rules"])) {
                this.rules = [] as any;
                for (let item of _data["rules"])
                    this.rules!.push(DecisionRule.fromJS(item));
            }
        }
    }

    static fromJS(data: any): DecisionTable {
        data = typeof data === 'object' ? data : {};
        let result = new DecisionTable();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["decisionName"] = this.decisionName;
...
export class DecisionVariableDefinition implements IDecisionVariableDefinition {
    name?: string | undefined;
    type?: DecisionVariableType;
    allowedValues?: string[] | undefined;

    constructor(data?: IDecisionVariableDefinition) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): DecisionVariableDefinition {
        data = typeof data === 'object' ? data : {};
        let result = new DecisionVariableDefinition();
        result.init(data);
        return result;
    }
...
export interface IDecisionVariableDefinition {
    name?: string | undefined;
    type?: DecisionVariableType;
    allowedValues?: string[] | undefined;
}

export enum DecisionVariableType {
    Int = "Int",
    String = "String",
    Bool = "Bool",
    Date = "Date",
...
export class ReplaceCaseAccessRuleUserRequest implements IReplaceCaseAccessRuleUserRequest {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.replacementUserId = _data["replacementUserId"];
        }
    }

    static fromJS(data: any): ReplaceCaseAccessRuleUserRequest {
        data = typeof data === 'object' ? data : {};
        let result = new ReplaceCaseAccessRuleUserRequest();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["replacementUserId"] = this.replacementUserId;
        return data;
    }
}
