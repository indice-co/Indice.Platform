...
/// <summary>Specifies methods for encrypting and decrypting data by using the Data Protection API.</summary>
/// <typeparam name="T">The type of the data to encrypt or decrypt.</typeparam>
public interface IDataProtectionEncryptor<T>
{
    /// <summary>Cryptographically protects a piece of plaintext data.</summary>
