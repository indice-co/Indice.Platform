...
{
    /// <summary>
    /// Tag helper that offers the ability to generate table header links used along with <see cref="ListOptions"/>.
    /// </summary>
    ...
    public class SortableTagHelper : TagHelper
    {
        ...
        /// <summary>
        /// Create a new instance of <see cref="SortableTagHelper"/>.
        /// </summary>
        ...
        /// <summary>
        /// List params used to navigate through collections.
        /// </summary>
        [HtmlAttributeName("list-options")]
        public ListOptions Options { get; set; }
        /// <summary>
        /// A model expression used in for sorting the table collection.
        /// </summary>
