...
namespace Microsoft.AspNetCore.Localization
{
    ...
    /// <summary>
    /// Determines the culture information for a request via the value of a predefined route parameter. Defaults to "culture" route key
    /// </summary>
    public class RouteRequestCultureProvider : IRequestCultureProvider
    {
        /// <summary>
        /// Result that indicates that this instance of <see cref="RouteRequestCultureProvider" /> could not determine the request culture.
        /// </summary>
