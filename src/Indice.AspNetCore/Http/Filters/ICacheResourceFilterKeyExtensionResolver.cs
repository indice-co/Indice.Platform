...
/// <summary>An optional extension to the cache key discriminator that will be created inside <see cref="CacheResourceFilterExtensions"/> and WithParameterValidation in minimal APIs.</summary>
