...
{
    /// <summary>
    /// Options for configuring ASP.NET Core DataProtection API using local file system.
    /// </summary>
    public class LocalDataProtectionOptions
    {
        internal IServiceCollection Services;
        /// <summary>
        /// The name of section when saving settings in configuration.
        /// </summary>
        public const string Name = "DataProtectionOptions";
        /// <summary>
        /// The path to the file system that will be used within the data protection system.
        /// </summary>
        public string Path { get; set; }
        /// <summary>
        /// Controls the lifetime (in days) of the private key. Defaults to 90 days. It gets rolled automatically, except if option <see cref="DisableAutomaticKeyGeneration"/> is set to true.
        /// </summary>
        public int KeyLifetime { get; set; }
        /// <summary>
        /// Stops the process of automatically rolling keys (create new keys) as they approach expiration.
        /// </summary>
