...
/// <summary>Extensions on type <see cref="ITempDataDictionary"/></summary>
public static class TempDataExtensions
{
    /// <summary>Adds information to the <see cref="TempDataDictionary"/> using a specified key.</summary>
    ...
    /// <summary>Retrieves information from the <see cref="TempDataDictionary"/> using a specified key.</summary>
    ...
    /// <summary>Retrieves information from the <see cref="TempDataDictionary"/> using a specified key, without marking the key for deletion.</summary>
    /// <typeparam name="T">The type of data to retrieve.</typeparam>
    /// <param name="tempData">Represents a set of data that persists only from one request to the next.</param>
    /// <param name="key">The key to use in the <see cref="TempDataDictionary"/>.</param>
    /// <returns>The data persisted in the <see cref="TempDataDictionary"/> under the specified key.</returns>
