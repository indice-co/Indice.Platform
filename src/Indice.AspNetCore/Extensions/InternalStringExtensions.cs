...
/// <summary>Useful extensions on <see cref="string"/> type.</summary>
internal static class InternalStringExtensions
{
    /// <summary>Ensures that a given path is prefixed with a '/' character.</summary>
    /// <param name="path">The given path.</param>
    public static string EnsureLeadingSlash(this string path) => $"/{path.TrimStart('/')}";

    /// <summary>Checks if a path contains a dynamic part (e.g. /users/{userId}/block).</summary>
    /// <param name="path">The given path.</param>
    ...
    /// <summary>Transforms a dynamic path into a templated one, used by application's internal structs.</summary>
    /// <param name="path">The given path.</param>
