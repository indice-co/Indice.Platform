...
public record EndpointBodyExampleMetadata(string ExampleName, Microsoft.OpenApi.Any.IOpenApiAny? Value, string? ExternalValue = null, string? Summary = null, string? Description = null, string ContentType = System.Net.Mime.MediaTypeNames.Application.Json);
