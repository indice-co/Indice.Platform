...
/// <summary>Allows to dynamically set the route prefix of a controller.</summary>
...
public class ApiPrefixControllerModelConvention : IControllerModelConvention
{
    ...
    /// <summary>Creates a new instance of <see cref="ApiPrefixControllerModelConvention"/>.</summary>
