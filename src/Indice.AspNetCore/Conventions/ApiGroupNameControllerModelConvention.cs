...
/// <summary>Allows to dynamically set the group name of a controller.</summary>
public class ApiGroupNameControllerModelConvention : IControllerModelConvention
{
    ...
    /// <summary>Creates a new instance of <see cref="ApiGroupNameControllerModelConvention"/>.</summary>
