...
/// <summary>Adds all derived types of any given <typeparamref name="TBaseType"/></summary>
...
public class PolymorphicSchemaFilter : ISchemaFilter
{
    ...
    /// <summary>Derived types of <see cref="BaseType"/></summary>
    public List<Type> DerivedTypes { get; }
    /// <summary>Derived types of <see cref="BaseType"/></summary>
    public IDictionary<string, string> DiscriminatorMap { get; }
    /// <summary>AnyOf AllOf List for <see cref="BaseType"/></summary>
    public IList<OpenApiSchema> AllOfReferences { get; }
    /// <summary>The property name used to determine the type of this object</summary>
