...
/// <summary>Searches all requests and responses to find a direct reference of a base type and makes it accept any of the desendants.</summary>
public class PolymorphicOperationFilter : IOperationFilter
{
    /// <summary>Constructs the operation filter sharing finctionality with <see cref="PolymorphicSchemaFilter"/></summary>
