...
{
    /// <summary>
    /// A filter that generates a corresponding header for action methods that require an antiforgery token as indicated by <see cref="ValidateAntiForgeryTokenAttribute"/>.
    /// </summary>
    public class AntiforgeryOperationFilter : IOperationFilter
    {
        /// <summary>
        /// Creates a new instance of <see cref="AntiforgeryOperationFilter"/>.
        /// </summary>
