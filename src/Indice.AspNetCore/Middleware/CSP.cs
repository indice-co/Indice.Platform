...
{
    /// <summary>This key is used to communicate generated nonces between the tag helper and the filter.</summary>
    ...
    /// <summary>Helper object that represents a browser CSP report request object.</summary>
