...
{
    /// <summary>
    /// Debug proxy endpoint configuration options. 
    /// </summary>
    public class DebugProfyOptions
    {
        /// <summary>
        /// Controls whether the endpoint will also register its own instance of <see cref="ForwardedHeadersMiddleware"/> and <seealso cref="HttpMethodOverrideMiddleware"/>. Defaults to true
        /// </summary>
    ...
    /// <summary>
    /// Registers an endpoint that allows to debug running behind a reverse proxy.
    /// Will register a GET endpoint that renders plain text to the response will all incoming headers
    /// </summary>
    ...
    /// <returns></returns>
    public static IEndpointConventionBuilder MapProxyDebug(this IEndpointRouteBuilder endpoints, string pattern, Action<DebugProfyOptions> configure = null) {
        var options = new DebugProfyOptions();
