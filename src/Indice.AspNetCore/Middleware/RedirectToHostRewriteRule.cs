...
namespace Indice.AspNetCore.Middleware
{
    ...
    public class RedirectToHostRewriteRule : IRule
    {
        ...
        /// <summary>
        /// Applies the rule. Implementations of ApplyRule should set the value for <see cref="RewriteContext.Result"/> (defaults to <seealso cref="RuleResult.ContinueRules"/>)
        /// </summary>
