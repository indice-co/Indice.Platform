...
{
    /// <summary>
    /// The <see cref="SecurityHeadersPolicy"/> is the configuration options for the <seealso cref="SecurityHeadersMiddleware"/>
    /// </summary>
    public class SecurityHeadersPolicy
    {
        /// <summary>
        /// Adds the <strong>X-Content-Type-Options</strong> header.. Defaults to <em>nosniff</em>
        /// </summary>
        ...
        /// <summary>
        /// Adds the <strong>Referrer-Policy</strong> header. Defaults to <em>strict-origin-when-cross-origin</em>
        /// </summary>
        ...
        /// <summary>
        /// Adds the <strong>X-Frame-Options</strong> header. Defaults to <em>SAMEORIGIN</em>
        /// </summary>
        ...
        /// <summary>
        /// Adds the <strong>Content-Security-Policy</strong> (Html only)
        /// </summary>
        public CSP ContentSecurityPolicy { get; set; } = CSP.DefaultPolicy.Clone();

        /// <summary>Checks the existance of the <see cref="XContentTypeOptions"/> setting.</summary>
        public bool HasXContentTypeOptions => !string.IsNullOrWhiteSpace(XContentTypeOptions);
        
        /// <summary>Checks the existance of the <see cref="ReferrerPolicy"/> setting.</summary>
        public bool HasReferrerPolicy => !string.IsNullOrWhiteSpace(ReferrerPolicy);
        
        /// <summary>Checks the existance of the <see cref="XFrameOptions"/> setting.</summary>
        public bool HasXFrameOptions => !string.IsNullOrWhiteSpace(XFrameOptions);

        /// <summary>Checks the existance of the <see cref="ContentSecurityPolicy"/> setting.</summary>
