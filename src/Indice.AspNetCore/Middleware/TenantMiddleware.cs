...
/// <summary>Used to populate active tenant information to the current User <see cref="ClaimsPrincipal"/> in a multitenant application API.</summary>
    ...
    where TTenant : class, ITenant
{
    ...
    /// <summary>Constructs a Subscription middleware passing the next request delegate in the pipeline.</summary>
    ...
    /// <summary>Gets the tenantId segment from the current route. </summary>
    ...
    /// <summary>Finds the id of a subscription by using the company alias.</summary>
    /// <param name="dbContext"></param>
...
/// <summary>Extensions for the <see cref="TenantMiddleware{TDbContext, TTenant}"/></summary>
