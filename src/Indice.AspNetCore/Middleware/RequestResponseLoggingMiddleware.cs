...
/// <summary>Middleware that handles the logging of requests and responses.</summary>
public class RequestResponseLoggingMiddleware
{
    ...
    /// <summary>Constructs the <see cref="RequestResponseLoggingMiddleware"/>.</summary>
    ...
    /// <summary>Default logging handler implementation. Adds two info log entries to the <see cref="ILogger"/>. One for the request and the other for the response.</summary>
    /// <param name="logger">Represents a type used to perform logging.</param>
...
/// <summary>Represents a request and response in order to be logged.</summary>
public class RequestProfilerModel
{
    private const int ReadChunkBufferLength = 4096;
    /// <summary>Constructs the model by passing the <see cref="Microsoft.AspNetCore.Http.HttpContext"/>.</summary>
    ...
    /// <summary>Request target is the http request method followed by the request path.</summary>
