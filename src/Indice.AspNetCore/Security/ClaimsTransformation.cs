...
/// <summary>Contains the Logic for normalizing claims types coming from external identity providers to the JWT standard ones.    </summary>
...
/// <summary>Extensions on the ASP.NET Core authentication regarding <see cref="ClaimsTransformation"/>.</summary>
public static class ClaimTransformationConfigurationExtensions
{
    ...
    /// <summary>Adds a claim transformation that contains the Logic for normalizing claims types coming from external identity providers to the JWT standard ones.</summary>
    /// <param name="services">Specifies the contract for a collection of service descriptors.</param>
