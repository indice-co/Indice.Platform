...
/// <summary>Provides helper functions for Authenication middleware forwarding logic.</summary>
public static class BearerSelector
{
    ...
    /// <summary>Extracts scheme and credential from Authorization header (if present).</summary>
