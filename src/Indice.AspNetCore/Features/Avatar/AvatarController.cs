...
namespace Indice.AspNetCore.Features
{
    ...
    internal class AvatarController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("{fullname}.{ext?}"), ResponseCache(Duration = 345600, Location = ResponseCacheLocation.Any, VaryByQueryKeys = new[] { "circular", "v" })]
        [AllowAnonymous]
        public IActionResult GetAvatar([FromRoute] string fullname, [FromRoute] string ext, [FromQuery] bool circular) => GetAvatar(fullname, size:null, background:null, ext, circular);
        ...
        /// <param name="circular">Determines whether the tile will be circular or sqare. Defaults to false (sqare)</param>
        /// <returns></returns>
        [HttpGet("{fullname}/{size?}"), ResponseCache(Duration = 345600, Location = ResponseCacheLocation.Any, VaryByQueryKeys = new[] { "circular", "v" })]
        [AllowAnonymous]
        public IActionResult GetAvatar([FromRoute] string fullname, [FromRoute] int? size, [FromQuery] bool circular) => GetAvatar(fullname, size, background:null, ext:null, circular);
        ...
        /// <param name="circular">Determines whether the tile will be circular or sqare. Defaults to false (sqare)</param>
        /// <returns></returns>
        [HttpGet("{fullname}/{size}.{ext?}"), ResponseCache(Duration = 345600, Location = ResponseCacheLocation.Any, VaryByQueryKeys = new[] { "circular", "v" })]
        [AllowAnonymous]
        public IActionResult GetAvatar([FromRoute] string fullname, [FromRoute] int? size, [FromRoute] string ext, [FromQuery] bool circular) => GetAvatar(fullname, size, background: null, ext, circular);
        ...
        /// <param name="circular">Determines whether the tile will be circular or sqare. Defaults to false (sqare)</param>
        /// <returns></returns>
        [HttpGet("{fullname}/{size}/{background}.{ext?}"), ResponseCache(Duration = 345600, Location = ResponseCacheLocation.Any, VaryByQueryKeys = new[] { "circular", "v" })]
        [AllowAnonymous]
        public IActionResult GetAvatar([FromRoute] string fullname, [FromRoute] int? size, [FromRoute] string background, [FromRoute] string ext, [FromQuery] bool circular) {
            ...
            return GetAvatar(firstName, lastName, size, ext, background, circular, null);
        }
        ...
        /// <returns></returns>
        [HttpGet, ResponseCache(Duration = 345600, Location = ResponseCacheLocation.Any, VaryByQueryKeys = new[] { "firstname", "lastname", "size", "ext", "background", "circular", "v" })]
        [AllowAnonymous]
        public IActionResult GetAvatar([FromQuery] string firstName, [FromQuery] string lastName, [FromQuery] int? size, [FromQuery] string ext, [FromQuery] string background, [FromQuery] bool circular, [FromQuery] string v) {
            ...
            AvatarGenerator.Generate(data, firstName, lastName, size ?? 192, ext == "jpg", background, circular);
