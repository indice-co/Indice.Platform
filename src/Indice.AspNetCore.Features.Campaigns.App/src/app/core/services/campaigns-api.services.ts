...
export interface ICampaignsApiService {
     ...
     * @return OK
     */
    createCampaignType(body?: CreateCampaignTypeRequest | undefined): Observable<CampaignType>;
    /**
     ...
     * @return OK
     */
    getCampaigns(page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined): Observable<CampaignResultSet>;
    /**
     ...
     * @return OK
     */
    getMessages(page?: number | undefined, size?: number | undefined, sort?: string | undefined, search?: string | undefined): Observable<UserMessageResultSet>;
    /**
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<UserMessageResultSet>><any>_observableThrow(e);
                }
            } else
                return <Observable<UserMessageResultSet>><any>_observableThrow(response_);
        }));
    }

    protected processGetMessages(response: HttpResponseBase): Observable<UserMessageResultSet> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 401) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserMessageResultSet.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<UserMessageResultSet>(<any>null);
    }
...
export class CreateCampaignTypeRequest implements ICreateCampaignTypeRequest {
    /** The name of a campaign type. */
    name?: string | undefined;

    constructor(data?: ICreateCampaignTypeRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateCampaignTypeRequest {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCampaignTypeRequest();
        result.init(data);
        return result;
    }
...
/** The request model used to create a new campaign type. */
export interface ICreateCampaignTypeRequest {
    /** The name of a campaign type. */
    name?: string | undefined;
}
...
export class UserMessageResultSet implements IUserMessageResultSet {
    count?: number;
    items?: UserMessage[] | undefined;

    constructor(data?: IUserMessageResultSet) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserMessageResultSet {
        data = typeof data === 'object' ? data : {};
        let result = new UserMessageResultSet();
        result.init(data);
        return result;
    }
...
export interface IUserMessageResultSet {
    count?: number;
    items?: UserMessage[] | undefined;
}
