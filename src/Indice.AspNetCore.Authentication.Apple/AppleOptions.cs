...
/// <summary>Configuration options for Apple OpenID Connect.</summary>
public class AppleOptions
{
    /// <summary>The full app id</summary>
    public string? AppId {
    ...
    /// <summary>The private key. The contents of the P8 key.</summary>
    public string? PrivateKey { get; set; }
    /// <summary>Private key id.</summary>
    public string? PrivateKeyId { get; set; }
    /// <summary>The client id. This should be a <see cref="ServiceId"/> created spesificly for web authentication.</summary>
    /// <remarks>
    /// Developers go in the identifiers section https://developer.apple.com/account/resources/identifiers
    /// </remarks>
    public string? ServiceId { get; set; }
    /// <summary>Your account's team ID or AppId prefix.</summary>
    ...
    /// <summary>Gets or sets the <see cref="OpenIdConnectEvents"/> to notify when processing OpenIdConnect messages.</summary>
