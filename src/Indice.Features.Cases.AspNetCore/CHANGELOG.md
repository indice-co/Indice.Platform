...
Added support for filter with user group extractd from claims
Fixed query issue when both case & checkpoint were specfied but filtered only with one of them
