...
{
    /// <summary>
    /// Cases resources describer. Extend this class for customization.
    /// </summary>
    public class CasesMessageDescriber
    {
        /// <summary>
        /// The comment to show at timeline when an agent edits a case.
        /// </summary>
        ...
        /// <summary>
        /// The comment to show at timeline when an agent tries to bypass four-eyes principle.
        /// </summary>
