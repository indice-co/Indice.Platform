...
namespace Indice.Features.Cases.Interfaces
{
    ...
    public interface ICaseMessageService
    {
        ...
        /// <summary>
        /// Send a <see cref="Message"/> that is specialized to create a new comment with an exception message and a private comment.
        /// </summary>
        /// <param name="caseId">The Id of the case.</param>
        /// <param name="user">The user that creates the message.</param>
    ...
    /// <summary>
    /// Placeholder to indicate MyCase feature.
    /// </summary>
    ...
    /// <summary>
    /// Placeholder to indicate Admin case feature.
    /// </summary>
