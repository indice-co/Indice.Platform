...
namespace Indice.Features.Cases.Workflows.Services
{
    internal class AwaitEditInvoker : BaseActivityInvoker, IAwaitEditInvoker
    {
        ...
        public Task<IEnumerable<CollectedWorkflow>> DispatchWorkflowsAsync(Guid caseId, string data, CancellationToken cancellationToken = default) =>
            base.DispatchWorkflowsAsync(caseId, data, cancellationToken);

        public Task<IEnumerable<CollectedWorkflow>> ExecuteWorkflowsAsync(Guid caseId, string data, CancellationToken cancellationToken = default) =>
            base.ExecuteWorkflowsAsync(caseId, data, cancellationToken);
