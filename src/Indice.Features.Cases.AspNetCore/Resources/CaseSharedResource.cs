...
namespace Indice.Features.Cases.Resources
{
    /// <summary>
    /// Shared resource service for localizing string to the consumer's module.
    /// </summary>
    public class CaseSharedResourceService
    {
        ...
        /// <summary>
        /// Create the instance with the corresponding assembly name / location where the resx files exist.
        /// </summary>
        ...
        /// <summary>
        /// Get a localized string to the <see cref="CultureInfo.CurrentUICulture"/> locale.
        /// </summary>
    ...
    /// <summary>
    /// Class to group shared case resources.
    /// </summary>
