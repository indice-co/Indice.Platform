...
export interface IIdentityApiService {
     ...
     * @return OK
     */
    addClaims(body?: CreateClaimRequest[] | null | undefined): Observable<ClaimInfo[]>;
    /**
...
export class IdentityApiService implements IIdentityApiService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ClaimInfoResultSet>><any>_observableThrow(e);
                }
            } else
                return <Observable<ClaimInfoResultSet>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetClaims(response: HttpResponseBase): Observable<ClaimInfoResultSet> {
        ...
        return _observableOf<ClaimInfoResultSet>(<any>null);
    }
    ...
    addClaims(body?: CreateClaimRequest[] | null | undefined): Observable<ClaimInfo[]> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddClaims(<any>response_);
                } catch (e) {
                    return <Observable<ClaimInfo[]>><any>_observableThrow(e);
                }
            } else
    ...
    updateClaim(claimId: number, body?: UpdateUserClaimRequest | undefined): Observable<ClaimInfo> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateClaim(<any>response_);
                } catch (e) {
                    return <Observable<ClaimInfo>><any>_observableThrow(e);
                }
            } else
    ...
    forgotPasswordConfirmation(body?: ForgotPasswordVerifyModel | undefined): Observable<void> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processForgotPasswordConfirmation(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
