...
export interface IIdentityApiService {
    ...
    /**
     * Returns a list of Indice.AspNetCore.Identity.Api.Models.AppSettingInfo objects containing the total number of app settings in the database and the data filtered according to the provided Indice.Types.ListOptions.
     * @param page (optional) 
     * @param size (optional) 
     * @param sort (optional) 
...
export class IdentityApiService implements IIdentityApiService {
    ...
    uploadCertificate(clientId: string, file?: FileParameter | undefined): Observable<SecretInfo> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUploadCertificate(<any>response_);
                } catch (e) {
    ...
    getCertificateMetadata(file?: FileParameter | undefined): Observable<SecretInfoBase> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCertificateMetadata(<any>response_);
                } catch (e) {
                    return <Observable<SecretInfoBase>><any>_observableThrow(e);
                }
            } else
                return <Observable<SecretInfoBase>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetCertificateMetadata(response: HttpResponseBase): Observable<SecretInfoBase> {
        ...
        return _observableOf<SecretInfoBase>(<any>null);
    }
    ...
    getExternalProviders(): Observable<ExternalProvider[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetExternalProviders(<any>response_);
                } catch (e) {
                    return <Observable<ExternalProvider[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<ExternalProvider[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetExternalProviders(response: HttpResponseBase): Observable<ExternalProvider[]> {
        ...
        return _observableOf<ExternalProvider[]>(<any>null);
    }
    ...
    patchClaims(body?: CreateClaimRequest[] | undefined): Observable<ClaimInfo[]> {
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPatchClaims(<any>response_);
                } catch (e) {
                    return <Observable<ClaimInfo[]>><any>_observableThrow(e);
                }
            } else
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<UserConsentInfoResultSet>><any>_observableThrow(e);
                }
            } else
                return <Observable<UserConsentInfoResultSet>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetConsents(response: HttpResponseBase): Observable<UserConsentInfoResultSet> {
        ...
        return _observableOf<UserConsentInfoResultSet>(<any>null);
    }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DeviceInfoResultSet>><any>_observableThrow(e);
                }
            } else
                return <Observable<DeviceInfoResultSet>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetDevices(response: HttpResponseBase): Observable<DeviceInfoResultSet> {
        ...
        return _observableOf<DeviceInfoResultSet>(<any>null);
    }
     ...
     */
    sendPushNotification(body?: SendPushNotificationRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/push-notifications";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendPushNotification(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    getUserExternalLogins(userId: string): Observable<UserLoginProviderInfo[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserExternalLogins(<any>response_);
                } catch (e) {
                    return <Observable<UserLoginProviderInfo[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<UserLoginProviderInfo[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetUserExternalLogins(response: HttpResponseBase): Observable<UserLoginProviderInfo[]> {
        ...
        return _observableOf<UserLoginProviderInfo[]>(<any>null);
    }
    ...
    deleteUserExternalLogin(userId: string, provider: string): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteUserExternalLogin(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
...
export class SendPushNotificationRequest implements ISendPushNotificationRequest {
    ...
    broadcast?: boolean;
    /** The user code. Required when Indice.AspNetCore.Identity.Api.Models.SendPushNotificationRequest.Broadcast has the value <i>false</i>. */
...
In the case of Indice.Services.TotpDeliveryChannel.PushNotification the {0} placeholder can be avoided so the message will be User Friendly in the Push Notification. The
{0} placeholder should be placed inside the Indice.AspNetCore.Identity.Features.TotpRequest.Data. */
    message?: string | undefined;
...
<remarks>This applies only for Indice.Services.TotpDeliveryChannel.PushNotification.</remarks> */
    classification?: string | undefined;
