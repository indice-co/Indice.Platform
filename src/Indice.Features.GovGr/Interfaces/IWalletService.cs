...
/// <summary>GovGr wallet service definition</summary>
public interface IWalletService
{
    /// <summary>Creates a request for identification document retrieval </summary>
    ...
    /// <summary>Retreives the identification document</summary>
