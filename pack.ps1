...
dotnet pack src/Indice.AspNetCore.Identity.AdminUI/Indice.AspNetCore.Identity.AdminUI.csproj --no-build -c Release -o ./artifacts
dotnet pack src/Indice.AspNetCore.Identity.UI/Indice.AspNetCore.Identity.UI.csproj --no-build -c Release -o ./artifacts
