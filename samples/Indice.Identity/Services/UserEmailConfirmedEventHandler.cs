...
/// <summary>Handler for <see cref="EmailConfirmedEvent"/> raised by IdentityServer API.</summary>
public class UserEmailConfirmedEventHandler : IPlatformEventHandler<EmailConfirmedEvent>
{
    ...
    /// <summary>Creates a new instance of <see cref="UserEmailConfirmedEventHandler"/>.</summary>
