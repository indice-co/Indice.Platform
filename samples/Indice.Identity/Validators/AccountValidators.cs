...
/// <summary>Validator for <see cref="ChangePasswordModel"/> model.</summary>
public class ChangePasswordValidator : AbstractValidator<ChangePasswordModel>
{
    /// <summary>Creates a new instance of <see cref="ChangePasswordValidator"/>.</summary>
...
/// <summary>Validator for <see cref="PasswordExpiredModel"/> model.</summary>
...
/// <summary>Validator for <see cref="ForgotPasswordRequest"/> model.</summary>
public class ForgotPasswordValidator : AbstractValidator<ForgotPasswordRequest>
{
    /// <summary>Creates a new instance of <see cref="ForgotPasswordValidator"/>.</summary>
    public ForgotPasswordValidator() => RuleFor(x => x.Email).EmailAddress().NotEmpty();
}

/// <summary>Validator for <see cref="LoginViewModel"/> model.</summary>
public class LoginValidator : AbstractValidator<LoginViewModel>
{
    /// <summary>Creates a new instance of <see cref="LoginValidator"/>.</summary>
...
/// <summary>Validator for <see cref="RegisterViewModel"/> model.</summary>
public class RegisterValidator : AbstractValidator<RegisterViewModel>
{
    /// <summary>Creates a new instance of <see cref="RegisterValidator"/>.</summary>
