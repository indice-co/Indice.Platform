...
/// <summary>Contains methods to get the system's predefined identity and API resources.</summary>
public static class Resources
{
    ...
    /// <summary>Gets the system's predefined identity resources.</summary>
    ...
    /// <summary>Gets the system's predefined APIs.</summary>
